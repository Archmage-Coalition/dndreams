...
public class ModDimensions {
    ...
    public static final Identifier HAVEN_ID = new Identifier(Initializer.MODID, "haven");
    ...
    public static final RegistryKey<DimensionType> HAVEN_TYPE_KEY = RegistryKey.of
            (Registry.DIMENSION_TYPE_KEY, HAVEN_ID);
    public static final RegistryKey<World> HAVEN_DIMENSION_KEY = RegistryKey.of
            (Registry.WORLD_KEY, HAVEN_ID);
