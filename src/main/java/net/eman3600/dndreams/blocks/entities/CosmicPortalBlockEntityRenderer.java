...
public class CosmicPortalBlockEntityRenderer<T extends CosmicPortalBlockEntity>
        implements BlockEntityRenderer<T> {

    public CosmicPortalBlockEntityRenderer(BlockEntityRendererFactory.Context ctx) {
    }
