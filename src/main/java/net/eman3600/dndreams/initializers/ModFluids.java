...
public class ModFluids {
    ...
    public static Block FLOWING_SPIRIT_BLOCK = ModBlocks.registerBlock("flowing_spirit", new FluidBlock(STILL_FLOWING_SPIRIT, FabricBlockSettings.copy(Blocks.WATER).luminance(state -> {
        return 7;
    })));
