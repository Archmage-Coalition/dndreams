...
public class SanityMobSpawner implements Spawner {

    private int cooldown = 0;
    private static final float PLAYER_DISTANCE = 8;
    private final Class<Entity> type;
    private final Function<TormentComponent, Integer> maxSpawns;
    private final Consumer2<World, BlockPos> spawner;

    public SanityMobSpawner(Class<Entity> type, Function<TormentComponent, Integer> maxSpawns, Consumer2<World, BlockPos> spawner) {
        this.type = type;
