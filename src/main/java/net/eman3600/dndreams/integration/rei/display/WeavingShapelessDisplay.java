...
public class WeavingShapelessDisplay implements Display {
    private List<EntryIngredient> input;
    private List<EntryIngredient> output;
    public final WeavingShapelessRecipe RECIPE;

    public WeavingShapelessDisplay(WeavingShapelessRecipe recipe) {
