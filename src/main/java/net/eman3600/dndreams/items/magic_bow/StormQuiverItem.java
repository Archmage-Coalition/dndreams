...
public class StormQuiverItem extends MagicQuiverItem implements ManaCostItem {

    public StormQuiverItem(Settings settings) {
        super(settings);
    }

    @Override
    public PersistentProjectileEntity createArrow(World world, ItemStack stack, LivingEntity shooter) {
        return new StormArrowEntity(world, shooter, false);
    }
