...
public class WitherBlossomBlock extends PlantBlock implements Fertilizable {
    ...
    public static final DamageSource WITHER_BLOSSOM_BUSH = DamageSourceAccess.create("wither_blossom_bush", false, true);
    ...
    public ItemStack getPickStack(BlockView world, BlockPos pos, BlockState state) {
        return new ItemStack(ModItems.WITHER_BLOSSOM_SEEDS);
    }
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if (i > 1) {
            ...
            dropStack(world, pos, new ItemStack(ModItems.WITHER_BUD, j + (bl ? 1 : 0)));
