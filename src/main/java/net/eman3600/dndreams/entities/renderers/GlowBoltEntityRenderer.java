...
public class GlowBoltEntityRenderer extends EntityRenderer<GlowBoltEntity> {
    private static final Identifier TEXTURE = new Identifier(MODID, "textures/entity/projectile/glow_bolt.png");
    private static final RenderLayer LAYER = RenderLayer.getEntityCutoutNoCull(TEXTURE);

    private static final float SCALE = 0.75f;

    public GlowBoltEntityRenderer(EntityRendererFactory.Context context) {
        super(context);
    }

    @Override
    protected int getBlockLight(GlowBoltEntity entity, BlockPos blockPos) {
        return 15;
    }

    @Override
    public void render(GlowBoltEntity entity, float f, float g, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i) {
        matrixStack.push();
    ...
    @Override
    public Identifier getTexture(GlowBoltEntity entity) {
        return TEXTURE;
    }
}
