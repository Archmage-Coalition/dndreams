...
public class ModStatusEffects {
    ...
    public static StatusEffect DREAMY = register("dreamy", new ModStatusEffect(StatusEffectCategory.BENEFICIAL, 0xf5d4ce).addAttributeModifier(ModAttributes.PLAYER_MANA_REGEN, "8C4A5112-9698-468A-B66A-A125711584F1", 0.5f, EntityAttributeModifier.Operation.MULTIPLY_TOTAL));
    ...
    public static StatusEffect AFFLICTION = register("affliction", new InstantModStatusEffect(StatusEffectCategory.HARMFUL, 0x352922));
