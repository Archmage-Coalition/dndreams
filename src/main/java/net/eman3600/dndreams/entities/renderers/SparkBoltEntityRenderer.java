...
public class SparkBoltEntityRenderer extends EntityRenderer<SparkBoltEntity> {
    private static final Identifier TEXTURE = new Identifier(MODID, "textures/entity/projectile/spark_bolt.png");
    private static final RenderLayer LAYER = RenderLayer.getEntityCutoutNoCull(TEXTURE);

    private static final float SCALE = 0.75f;

    public SparkBoltEntityRenderer(EntityRendererFactory.Context context) {
        super(context);
    }

    @Override
    protected int getBlockLight(SparkBoltEntity entity, BlockPos blockPos) {
        return 15;
    }

    @Override
    public void render(SparkBoltEntity entity, float f, float g, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i) {
        matrixStack.push();
    ...
    @Override
    public Identifier getTexture(SparkBoltEntity entity) {
        return TEXTURE;
    }
}
